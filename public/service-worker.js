const cacheName = "khulan-language-v16";
const coreFiles = ["/","/index.html","/styles.css?v=9","/topik.css?v=2","/topik-ch02.css?v=1","/topik-utils.js?v=2","/topik.js?v=4","/topik-ch02.js?v=1","/app.js?v=13","/lessons/hangul-foundation.html","/lessons/hangul-review-source.html","/data/lessons.js","/data/korean-pdf-additions.js?v=1","/data/korean-curriculum.js?v=4","/data/korean-master.js?v=6","/data/korean-grammar-explained.js?v=7","/manifest.webmanifest","/vendor/lucide.js","/app-icon-192.png","/app-icon-512.png"];
